...
def app():
    ...
    if platform.system() == "Darwin": # If you are using a Mac
        ...
        b4 = Button(frame, text="Runs Scored by Various Players", command=plot_runs, highlightbackground="#117A65", fg="white").pack(side = LEFT)
        b5 = Button(frame, text="Best Batsmen", command=plot_best_batsmen, highlightbackground="#34495E", fg="white").pack(side = LEFT)
        b6 = Button(bottomframe, text="Stop", command=root.destroy, highlightbackground="red", fg="white").pack(side = BOTTOM)
        ...
        b4 = Button(frame, text="Runs Scored by Various Players", command=plot_runs, bg="#117A65", fg="white").pack(side = LEFT)
        b5 = Button(frame, text="Best Batsmen", command=plot_best_batsmen, bg="#34495E", fg="white").pack(side = LEFT)
        b6 = Button(bottomframe, text="Stop", command=root.destroy, bg="red", fg="white").pack(side = BOTTOM)
